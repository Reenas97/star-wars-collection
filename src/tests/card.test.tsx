...
describe("Card", () => {
    ...
    it("should render the right name", () => {
        render(<Card name="Darth Vader" imageUrl="https://example.com/luke.jpg" link={mockLink} />);
    ...
    it("should render the right home planet when it exists", () => {
        render(<Card name="Darth Vader" homeworld="Tatooine" imageUrl="https://example.com/luke.jpg" link={mockLink} />);
